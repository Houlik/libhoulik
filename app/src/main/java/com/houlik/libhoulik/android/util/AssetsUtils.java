...
public class AssetsUtils {
    ...
    /**
     * 将Assets文件夹内的数据库拷贝到主机内存当前项目中
     * @param context
     * @param url "/data/data/com.项目.名称/databases/数据库名称.db"
     * @param dataname 数据库名称.db
     */
    public void copyDatabase2SDFromAssets(Context context,String url, String dataname){
        try {
            InputStream is = context.getAssets().open(dataname);
